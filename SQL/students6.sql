...
CREATE TABLE `users` (
                         ...
                         constraint user_ville_id_fk foreign key (user_ville_id) references villes (id),
                         constraint user_etudiant_id_fk foreign key (user_etudiant_id) references etudiantd (id),
                         `created_at` timestamp NULL DEFAULT NULL,
                         `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `forums` (
                          ...
                          constraint forum_user_id_fk foreign key (forum_user_id) references users (id),
                          `created_at` timestamp NULL DEFAULT NULL,
                          `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
